...
# testing Views that are restricted to logged in users
...
# Warning
# If you use the form class RenewBookModelForm(forms.ModelForm) instead of class RenewBookForm(forms.Form),
# then the form field name is 'due_back' instead of 'renewal_date'.
